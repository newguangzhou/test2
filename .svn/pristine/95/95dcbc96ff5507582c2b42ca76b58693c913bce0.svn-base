...
AUTH_INFOS_TB_INDEXES = [
    IndexModel([("type", pymongo.ASCENDING), ("auth_id", pymongo.ASCENDING)], unique = True),
    IndexModel([("type", pymongo.ASCENDING), ("mobile_num", pymongo.ASCENDING)], unique = True),
    IndexModel("add_date"),
    IndexModel("mod_date"),
    IndexModel("state"),
    ]
...
VERIFY_CODE_STATUS_TB_INDEXES = [
    IndexModel([("auth_type", pymongo.ASCENDING), ("type", pymongo.ASCENDING), ("mobile_num", pymongo.ASCENDING)], unique = True),
    IndexModel("add_date")
    ]
...
AUTH_STATUS_TB_INDEXES = [
    IndexModel([("auth_type", pymongo.ASCENDING), ("auth_id", pymongo.ASCENDING), ("token", pymongo.ASCENDING)]),
