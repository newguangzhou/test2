...
class PyLoader:
    ...
    def ReloadInst(self, class_name, *args, **kwargs):
        ...
        try:
            ...
            logging.error("Can not reload inst, import error, module=\"%s\" class_name=\"%s\" trace=\"%s\"", self._module, class_name, traceback.format_exc())
        ...
        try:
            ...
            logging.error("Reload inst error, module=\"%s\" class_name=\"%s\" trace=\"%s\"", self._module, class_name, traceback.format_exc())
